...
class Request {
  ...
  init(name: CustomerRequest, accountNumber: String, amount: Int) {
    Request.requestId = Request.requestId + 1
    self.name = name
    self.accountNumber = accountNumber
    self.amount = amount
...
class Bank{
  ...
  func createRequest(accountNumber: String, requestType: CustomerRequest, amount: Int) {
    requestList.append(Request(name: requestType, accountNumber: accountNumber,amount: amount)) 
  ...
  func proceesRequest() {
    for (index,request) in requestList.enumerated() {
      ...
      switch(request.name) {
        ...
        case CustomerRequest.CheckPrevoiousTransaction : print("The Transaction Detail of the accountHolder \(request.accountNumber)")
        ...
        case CustomerRequest.WithdrawAmount : print("")

        debitAmount(accountNumber: request.accountNumber, amount: request.amount)
...
canarabank.createRequest(accountNumber: "520910100001" , requestType: CustomerRequest.CheckPrevoiousTransaction)
canarabank.createRequest(accountNumber: "520910100001" , requestType: CustomerRequest.WithdrawAmount, amount: 100)
canarabank.proceesRequest()
